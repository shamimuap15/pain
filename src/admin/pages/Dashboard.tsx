    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        {[
          ...
          { label: 'Total Revenue', value: `৳${stats.totalRevenue.toLocaleString()}`, icon: TrendingUp, color: 'bg-green-50 text-green-600' },
          { label: 'Customers', value: stats.uniqueCustomers, icon: Users, color: 'bg-purple-50 text-purple-600' },
